...
public class AchievementUserController {
    ...
    public Result<Page<AchListVO>> pageList4User(@RequestBody AchListDTO achListDTO, @CurrentUser KeycloakUser curretUser){
        return Result.success(achievementMainsService.pageList4UserAch(achListDTO, curretUser.getId()));
    }
